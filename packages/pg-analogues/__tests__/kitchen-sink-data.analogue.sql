...
insert into c.person (id, person_full_name, email, about, last_login_from_ip, created_at) values
  (1, 'John Smith', 'john.smith@email.com', null, '192.168.0.1', null),
  (2, 'Sara Smith', 'sara.smith@email.com', null, '10.1.2.3', null),
  (3, 'Budd Deey', 'budd.deey@email.com', 'Just a friendly human', '172.21.22.23', null),
  (4, 'Kathryn Ramirez', 'kathryn.ramirez@email.com', null, '192.168.1.2', null),
  (5, 'Joe Tucker', 'joe.tucker@email.com', null, '192.168.0.2', null),
  (6, 'Twenty Seventwo', 'graphile-build.issue.27.exists@example.com', null, '10.1.2.254', null);
