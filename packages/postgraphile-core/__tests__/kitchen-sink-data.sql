insert into c.person (id, person_full_name, email, about, config, created_at) values
  ...
  (5, 'Joe Tucker', 'joe.tucker@email.com', null, 'a => 5, b => 6, nl => NULL, null_string => null, "_\"_$@£$)(@*£$" => "_\"_$@£$)(@*£$"', null),
  (6, 'Twenty Seventwo', 'graphile-build.issue.27.exists@example.com', null, 'a => NULL, b => null', null);
