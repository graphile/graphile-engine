...
-- select setval('pg11.network_id_seq', 9); -- alter sequence pg11.network_id_seq restart with 9;
...
-- select setval('pg11.types_id_seq', 15); -- alter sequence pg11.types_id_seq restart with 15;
