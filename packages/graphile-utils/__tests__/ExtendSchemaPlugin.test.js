...
it("throws the proper error if an array of typeDefs aren't all DocumentNodes", () => {
  return expect(
    ...
    `[Error: All elements given to an array passed as the first argument of makeExtendSchemaPlugin must be generated by the \`gql\` helper.]`
  );
});
...
it("throws the proper error if a single typeDef isn't a DocumentNode", () => {
  return expect(
    ...
    `[Error: The first argument to makeExtendSchemaPlugin must be generated by the \`gql\` helper, or an array of the same.]`
  );
});
