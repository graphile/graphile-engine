...
type SubscriptionReleaser = () => undefined;
type SubscriptionCallback = () => undefined;
...
export class LiveMonitor {
  released: boolean;
  providers: {
    [namespace: string]: LiveProvider;
  };
  subscriptionReleasers: () => undefined[];
  changeCallback: (() => undefined) | null;
  ...
  reset() {
    ...
    this.subscriptionReleasers = []; // Delete everything from liveConditions, we'll be getting fresh conditions soon enough
  ...
  onChange: (callback: () => undefined) => undefined;
